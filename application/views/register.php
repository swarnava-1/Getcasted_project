                        ...
                        <div class="p-5">
                            ...
                            <div class="text-center">
								...
								<a href="<?php echo base_url();?>"><img style="width:200px;" src="<?php echo base_url();?>assets/img/logo.jpg" alt=""/></a>
											<p class="subTxt"> Join Casted today and land your perfect role </p>
							  ...
							  <ul class="nav nav-pills nav-tabs" role="tablist">
								<li class="nav-item">
								  <a class="nav-link nav-link1 active" data-toggle="tab" href="#home">Register as a casted director / Agents</a>
								</li>
								
								<li class="nav-item">
								  <a class="nav-link nav-link2" data-toggle="tab" href="#menu1">Register as a Artist</a>
								</li>
							  </ul>
							...
							<form class="user" action="<?php echo base_url();?>register/newTalent" method = "post" enctype="multipart/form-data">
								...
								<div class="col-sm-12 mb-3 mb-sm-0">
                                        <div class="form-control form-control-radio">
											...
											<div class="form-check-inline">
											  <label class="form-check-label" for="radio2">
												<input type="radio" class="form-check-input" id="radio2" value="Others" name="gender" required>Others
											  </label>
											</div>
										</div>	
                                    </div>
								...
								<div class="form-group row">
									...
									<label>Select Inches</label>
										<input type="text" class="form-control form-control-date" id="exampleFirstName" placeholder="Put chest size" name="clothing_size_chest_inch" required>
                                    </div> 
                                </div>
								<div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">	
									...
									<div class="col-sm-6 mb-3 mb-sm-0">
									<label>Select Inches</label>
										<input type="text" class="form-control form-control-date" id="exampleFirstName" placeholder="Put bust size" name="clothing_size_bust_inch" required>
                                    </div> 
                                </div>
								<div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">	
