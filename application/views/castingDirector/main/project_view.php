				...
				<div class="modal-dialog modal-lg">
				  <div class="modal-content">
                    ...
                    <form class="user" action ="<?php echo base_url();?>castingDirector/director/update_role" method="post">
								...
								<div class="form-group row">
									<div class="col-sm-6 mb-3 mb-sm-0">
										<textarea class="form-control form-control-user" id="op_shoot_dates" placeholder="shoot date" name="optional_shoot_dates" rows="2" required></textarea>
                                    </div>  
                                </div>
								<div class="form-group row">
									<div class="col-sm-6 mb-3 mb-sm-0">
										<textarea class="form-control form-control-user" id="aud_date" placeholder="audition date" name="optional_audition_dates" rows="2" required></textarea>
                                    </div>  
                                </div>
								<div class="form-group row">
									<div class="col-sm-6 mb-3 mb-sm-0">
										<textarea class="form-control form-control-user" id="sholoc" placeholder="shoot location" name="shoot_location" rows="2" required></textarea>
                                    </div>  
                                </div>
								<div class="form-group row">
									<div class="col-sm-6 mb-3 mb-sm-0">
										<textarea class="form-control form-control-user" id="audloc" placeholder="audition location" name="audition_location" rows="2" required></textarea>
                                    </div>  
                                </div>
