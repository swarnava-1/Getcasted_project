                                ...
                                <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#" data-toggle="modal" data-target="#myModalCreateRole" onclick="javascript:load_projects('<?php echo $project['optional_shoot_dates'];?>','<?php echo $project['optional_audition_dates'];?>','<?php echo $project['shoot_location'];?>','<?php echo $project['audition_location'];?>',<?php echo $project['id'];?>)">Create role</a></td>
                                            <td>
				  ...
				  <div class="modal-content">
					...
					<div class="modal-body">
						<form action ="<?php echo base_url();?>castingDirector/director/create_project" method="post" class="user">
							...
							<div class="form-group row">
								<div class="col-sm-6 mb-3 mb-sm-0">
								<label for="birthdaytime">Cut off time for self-tape submissions:</label>
									<input type="datetime-local" class="form-control form-control-user" id="exampleInputEmail" placeholder="Cut off time for self-tape submissions" name="cutt_off_time" required>
								</div>
								<div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <form class="user" action ="<?php echo base_url();?>castingDirector/director/create_role" method="post">
								...
								<div class="form-group row">
									...
									<label>Shoot Dates</label>
										<input id="op_shoot_dates" type="text" class="form-control form-control-user" placeholder="Role Name" name="optional_shoot_dates" required>
                                    </div>
								</div>
								...
								<div class="form-group row">
									...
									<label>Audition Dates</label>
										<input id="aud_date" type="text" class="form-control form-control-user" placeholder="Aud names" name="optional_audition_dates" required>
                                    </div>
								</div>
								<div class="form-group row">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
									<label>Shoot location</label>
										<input id="sholoc" type="text" class="form-control form-control-user" placeholder="location  Name" name="shoot_location" required>
                                    </div>
								</div>
								<div class="form-group row">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
									<label>Audition location</label>
										<input id="audloc" type="text" class="form-control form-control-user" placeholder="location  Name" name="audition_location" required>
                                    </div>
										</div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
								...
								<div class="form-group row">
                                    <div class="col-sm-6 mb-2 mb-sm-0">
									 ...
									 <input type="range" id="points" name="age_range" min="1" max="100">
                                    </div>
									<div class="col-sm-6 mb-3 mb-sm-0">
								...
								<div class="form-group row">
									...
									<label>Gender</label>
                                        <div class="form-control form-control-radio">
											...
											<div class="form-check-inline">
											  <label class="form-check-label" for="radio2">
												<input type="radio" class="form-check-input" name="gender" required value="Transmale">Transmale 
											  </label>
											  
											</div>
											<div class="form-check-inline">
											  <label class="form-check-label" for="radio2">
												<input type="radio" class="form-check-input" name="gender" required value="Transfemale">Transfemale  
											  </label>
											  
											</div>
											<div class="form-check-inline">
											  <label class="form-check-label" for="radio2">
												<input type="radio" class="form-check-input" name="gender" required value="Non-binary">Non-binary   
											  </label>
								...
								<div class="form-group row">
									...
									<label>Select Inches</label>
									    <select class="form-control form-control-select" name="clothing_size_chest_inch" >
								...
								<div class="form-group row">
									...
									<div class="col-sm-6 mb-3 mb-sm-0">
									<label>Select Inches</label>
									    <select class="form-control form-control-select" name="clothing_size_bust_inch" >
								...
								<div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">	
									<label>Clothing Size</label>
										<select class="form-control form-control-select" name="clothing_size_waist" >
											<option value="Waist">Waist</option>
										</select>
                                    </div>
									<div class="col-sm-6 mb-3 mb-sm-0">
									<label>Select Inches</label>
									    <select class="form-control form-control-select" name="clothing_size_waist_inch" >
								...
								<div class="form-group row">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
									<label>Self Tape Instruction </label>
										<input id="audloc" type="text" class="form-control form-control-user" placeholder="self tape instruction " name="" required>
                                    </div>
										</div>
								<div class="form-group row">
								<div class="col-sm-6 mb-3 mb-sm-0">
								...
								<div class="form-group row">
									...
									<div class="col-sm-6 mb-3 mb-sm-0">
									<label>Select Agent(repped or non repped)</label>
									<select id="agentSelect" class="form-control form-control-select" name="agent" required>
											<option selected> Select Agent</option>
											<option value="Repped">Repped</option>
											<option value="Non Repped">Non Repped</option>
...
<script type="text/javascript">
function load_projects(optional_shoot_dates,optional_audition_dates,shoot_location,audition_location,id)
	{
		$.ajax({
				type: "POST",
				data: "id="+id+"optional_shoot_dates="+optional_shoot_dates+"optional_audition_dates="+optional_audition_dates+"shoot_location="+shoot_location+"audition_location="+audition_location,
				success: function (response) {	
					//$("#id_field").val()=id;
					document.getElementById ("id_field").value = id;
					document.getElementById ("op_shoot_dates").value = optional_shoot_dates;
					 document.getElementById ("aud_date").value = optional_audition_dates;
					 document.getElementById ("sholoc").value = shoot_location;
					 document.getElementById ("audloc").value = audition_location;
				}
			});
	}
</script>
