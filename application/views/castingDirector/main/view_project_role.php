            ...
            <form class="user">
				...
				<div class="form-group row">
					<div class="col-sm-6 mb-3 mb-sm-0">
						<lable>Shoot date</lable>
						<input type="text" class="form-control form-control-user" id="op_shoot_dates"  value="<?php echo $role_by_id[0]['optional_shoot_dates'];?>" readonly>
					</div>
					<div class="col-sm-6 mb-3 mb-sm-0">
						<lable>Audition date</lable>
						<input type="text" class="form-control form-control-user" id="aud_date"  value="<?php echo $role_by_id[0]['optional_audition_dates'];?>" readonly>
					</div>
            	</div>
				<div class="form-group row">
					<div class="col-sm-6 mb-3 mb-sm-0">
						<lable>Shoot location</lable>
							<input type="text" class="form-control form-control-user" id="sholoc" value="<?php echo $role_by_id[0]['shoot_location'];?>" readonly>
					</div>
					<div class="col-sm-6 mb-3 mb-sm-0">
					<lable>Audition Location</lable>
							<input type="text" class="form-control form-control-user" id="audloc" value="<?php echo $role_by_id[0]['audition_location'];?>" readonly>
					</div>  
				</div>
