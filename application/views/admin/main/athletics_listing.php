...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 pageTitle">Athletics  Listing</h1>
</div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Athletics  Name </th>
                                           
                                            <th>Action</th>
                                        </tr> 
                                    </thead>
                                    <tbody>
										<?php foreach($athletics as $athle)  {?>
                                        <tr>
                                            <td><?php echo $athle['athletics_name'];?></td>
											<td>
											<!-- <a href="<?php echo base_url();?>admin/dancing/view_dancing?dancing_id=<?php// echo $danc['id'];?>" class="btn btn-primary"><i class="far fa-eye"></i></a> -->
											    <a href="<?php echo base_url();?>admin/athletics/view_athletics?athletics_id=<?php echo $athle['id'];?>" class="btn btn-success"><i class="fas fa-edit"></i></a>
												<a href="#" onclick="checkDelete(<?php echo $athle['id']; ?>)" class="btn btn-danger"><i class="far fa-trash-alt"></i></a>
											</td>
                                        </tr>
										<?php } ?>										
                                    </tbody>
                                </table>
								<button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#myModalAdd">Create Athletics</button>
                            </div>
                        </div>
                    </div>
                </div>
			  ...
			  <div class="modal fade" id="myModaledit">
				<div class="modal-dialog modal-lg">
				  <div class="modal-content">
					...
					<!-- Modal Header -->
					<div class="modal-header">
					  <h4 class="modal-title">Edit Athletics</h4>
					  <button type="button" class="close" data-dismiss="modal" onClick="window.location.reload();">&times;</button>
					</div>
					
					<!-- Modal body -->
					<div class="modal-body">
						<form action ="<?php echo base_url();?>admin/athletics/update_athletics" method="post" class="user">
						<div class="form-group row">
								<div class="col-sm-12 mb-3 mb-sm-0">
									<input type="text" class="form-control form-control-user" id="athletics_name" placeholder="athletics Name" name="athletics_name" required>
								</div>
							</div>
							</div>
							<!-- Modal footer -->
