...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 pageTitle">Agent  Listing</h1>
</div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $agent['company_name_or_individual_name'];?></td>
                                            <td><?php echo $agent['contact_no'];?></td>
                                            <td><?php echo $agent['email_id'];?></td>
											<td>
											 <a href="<?php echo base_url();?>admin/agent/view_agents?agents_id=<?php echo $agent['id'];?>" class="btn btn-primary"><i class="far fa-eye"></i></a> 
