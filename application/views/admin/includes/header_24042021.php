...
<html>
    <head>
        ...
        <!-- DataTables -->
        <!--<link href="<?php echo base_url();?>assets/admin2/assets/datatables/jquery.dataTables.min.css" rel="stylesheet" type="text/css" />-->
        ...
        <!--<script src="<?php echo base_url();?>assets2/assets/assets/admin2/js/modernizr.min.js"></script>-->
  ...
  <body class="fixed-left">
        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                <!-- LOGO -->
                <div class="topbar-left" style="background:#052431cf;">
                    <div class="text-center">
                        <a href="<?php echo base_url();?>index"><h3 style="color: white;"> Admin Panel</h3></a>
                    </div>
                </div>
                <!-- Button mobile view to collapse sidebar menu -->
                <div class="navbar navbar-default" role="navigation">
                    <div class="container" style="background:#052431cf;">
                        <div class="">
                           <!-- <div class="pull-left">
...
-->
                            <ul class="nav navbar-nav navbar-right pull-right">
                                ...
                                <li class="dropdown">
                                    <a href="" class="dropdown-toggle profile" data-toggle="dropdown" aria-expanded="true"><img src="<?php echo base_url();?>assets2/assets/admin2/images/avatar-1.jpg" alt="user-img" class="img-circle"> </a>
                                    <ul class="dropdown-menu">
                                        <!--<li><a href="javascript:void(0)"><i class="md md-face-unlock"></i> Profile</a></li>-->
                                        <li><a href="changepassword"><i class="md md-settings"></i> Change Password</a></li>
