...
.tree li a:hover+ul ul::before{
	border-color:  #94a0b4;
      ...
      <?php 
            if($admin_user[0]->status ==1){
				$style	=	"style='background-color: green;color: black;'";
			}else{
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <div class="panel-body" style="background:skyblue;">
                                            <div class="row">
                                                    ...
                                                    <div class="table-responsive" data-pattern="priority-columns">
                                                        <div class="col-sm-offset-1">
                                                            <div class="tree">
                                                                <ul>
                                                                    <li>
                                                    			        <a <?php echo $style ; ?> href="#"><?php echo $this->session->userdata('applicantId'); ?></a>
                                                    			        <?php active_customer($this->session->userdata('applicantId')); ?>
                                                                    </li>		
                                                                </ul>	 
                                                            </div>
                                                        </div>
