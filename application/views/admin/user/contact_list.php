                                                ...
                                                <table id="datatable" class="table table-striped table-bordered">
                                                   ...
                                                   <tbody>
                                                        ...
                                                        <?php } else { ?>
                                                            ...
                                                            <td><center>
                                                            <a href="<?php echo base_url();?>contacts/view_contact?id=<?php echo $row->id;?>"><i class="fa fa-eye"></i></a>
                                                            <a href="#" data-toggle="modal" data-target="#myModal"></a>
                                                            <a href="<?php echo base_url();?>contacts/edit_contact?id=<?php echo $row->id;?>"><i class="fa fa-edit"></i></a>
                                                            <a href="#" class="on-default remove-row" onclick="checkDelete(<?php echo $row->id; ?>)"><i class="fa fa-trash-o"></i></a> <center></td>
                                                        </tr>
                                                         <?php } ?>
                                                    </tbody>
                                                </table>
