            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">Reply message</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Reply</h3></div>
                                    <div class="panel-body">
                                        <div class=" form">
                                            <form class="cmxform form-horizontal tasi-form" onsubmit="return validate_quote();" action="<?php echo base_url();?>reply/update_reply" method="post" enctype="multipart/form-data">
                                                <div class="form-group ">
                                                    <label for="lastname" class="control-label col-lg-2">Add Accounts</label>
                                                    <div class="col-lg-10">
                                                        <?php $acc_id = $number[0]->contact_id;$account_id_exp = explode(',',$acc_id);?>
                                                         <select class="form-control selectpicker" multiple data-live-search="true" id="contact_id" name="contact_id[]">
                                                          <!--<option value="">Please select</</option>-->
                                                              <?php foreach($contacts as $acc){?>
                                                                  <option value="<?php echo $acc->id;?>" <?php foreach($account_id_exp as $eip){ if($eip==$acc->id){echo 'selected';}}?>><?php echo $acc->Name;?></option>
                                                              <?php }  ?>
                                                         </select>
                                                    </div>
                                                </div>
                                                <input type="hidden" name="id" value="<?php echo $number[0]->id;?>">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <input class=" form-control" id="cc" name="cc" placeholder="Cc" value="<?php echo $number[0]->cc;?>" type="text">
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <label for="lastname" class="control-label col-lg-2">Bcc</label>
                                                    <div class="col-lg-10">
                                                        <input class=" form-control" id="bcc" name="bcc" placeholder="Bcc" value="<?php echo $number[0]->bcc;?>" type="text">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-lg-offset-2 col-lg-10">
                               <button type="submit" class="btn btn-success waves-effect waves-light">Submit</button><a href="<?php echo base_url().'reply'?>"><button class="btn btn-default waves-effect" type="button">Cancel</button></a>
                                                    </div>
                                                </div>
                                            </form>
                                        </div> <!-- .form -->
