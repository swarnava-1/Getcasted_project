                                        ...
                                        <div class=" form">
                                            <form class="cmxform form-horizontal tasi-form" onsubmit="return validate_quote();" action="<?php echo base_url();?>mom/insert_mom" method="post" enctype="multipart/form-data">
                                                <div class="form-group " id="d_name">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <input class="form-control" id="date" name="date" value="<?php echo $number[0]->date?>" placeholder="Date" type="date" required="required">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <input class="form-control" class="form-control" value="<?php echo $number[0]->subject;?>" id="subject" name="subject" placeholder="Subject" required="required">
                                                    </div>
                                                </div>
                                                <div class="form-group " id="d_name">
                                                    <label for="firstname" class="control-label col-lg-2">Minutes of Meeting Description</label>
                                                    <div class="col-lg-10">
                                                        <textarea class="form-control" id="description" name="description" value="" placeholder="Minutes of Meeting description" type="text" required="required"><?php echo $number[0]->description;?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
