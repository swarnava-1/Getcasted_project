                                                ...
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php if($this->session->userdata('name')=='Admin') {echo $row->password;}else{echo 'N/A';}?></td>
                                                            <td><?php echo $row->sponsorId;?></td>
                                                            <td><strong>Level-</strong><?php echo $row->usr_label;?></td>
                                                            <td><?php echo $row->email; ?></td>
                                                            <td><?php echo $row->mobile;?></td>
                                                            <td><b>A/C:</b><?php echo $row->accname;?>,<b>IFSC:</b><?php echo $row->ifsccode;?>,<b>Bank Name:</b><?php echo $row->bankname;?></td>
                                                            ...
                                                            <?php } ?></div><?php } else {?>
                                                              ...
                                                              <div style="display: block;"><?php if($row->status=='1'){?><button class="btn btn-block btn-success btn-xs">Active</button><?php } else {?>
                                                              <button class="btn btn-block btn-danger btn-xs">Inactive</button>
                                                            <?php } ?></div><?php } ?>
                                                        ...
                                                        <?php } ?>    <br><br>     
                                                          <!--<a href="<?//php echo base_url();?>admin/customers/income?id=<?php// echo $row->id?>"><button class="btn btn-block btn-primary btn-xs">Open</button></a>-->
                                                            </td>
