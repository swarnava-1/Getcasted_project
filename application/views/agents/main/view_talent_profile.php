<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 pageTitle">View Talent details</h1>
    </div>
    ...
    <div class="card-body">
            ...
            <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                <lable>Address</lable>
                    <input type="text" class="form-control form-control-date" id="exampleFirstName" placeholder="Expiration Date" name="expiration_date" value="<?php echo $talents[0]['talent_address'];?>" readonly>
                </div>
                <div class="col-sm-6 mb-3 mb-sm-0">
            ...
            <div class="form-group row">
                ...
                <lable>Agent Info</lable>
                    <input type="text" class="form-control form-control-date" id="exampleFirstName" placeholder="Geographic Area" name="geographic_area" value="<?php echo $this->session->userdata('user_name');?>" readonly>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
