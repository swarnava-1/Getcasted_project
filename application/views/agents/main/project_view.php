                                ...
                                <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url();?>agents/agent/view_project_role?id=<?php echo $role['id'];?>&project_id=<?php echo $this->input->get('id');?>" class="btn btn-primary"><i class="far fa-eye"></i></a>
											</td>
                                        </tr>
                                        <?php } ?> 										
                                    </tbody>
